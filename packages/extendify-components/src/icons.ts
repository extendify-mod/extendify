import type { SemanticColor } from "@extendify/components/spotify";
import { exportFilters, findModuleComponent, type LazyComponent } from "@extendify/webpack/module";
...
export const BookshelfIcon = findIcon("M8.375 1.098a.75.75");
export const ShareIcon = findIcon("M1 5.75A.75.75 0");
