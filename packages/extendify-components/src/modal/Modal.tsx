import { useEffect } from "@extendify/api/react";
import { CloseIcon } from "@extendify/components/icons";
import { ButtonTertiary, ModalWrapper, Text } from "@extendify/components/spotify";
