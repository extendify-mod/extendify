...
import { platform, resolveApi } from "@extendify/api/platform";
import { React } from "@extendify/api/react";
import { globalStore } from "@extendify/api/redux";
import { contextOptions, moduleCache, services, settingsValues } from "@extendify/api/registry";
...
export async function getExportedComponents() {
    ...
    const components = (await import("@extendify/components/spotify")) as any;
