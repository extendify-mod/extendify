...
import { emitEvent, registerEventListener } from "@extendify/api/context/event";
import { exportFunction, registerPatch } from "@extendify/api/context/patch";
import { overriddenFunctions } from "@extendify/api/registry";
import { createLazy } from "@extendify/shared/lazy";
import type { AnyFn } from "@extendify/shared/types";
import type {
    Platform,
    ProductStateAPI,
    RemoteConfigDebugAPI
} from "@extendify/shared/types/spotify";
import type { PlaybackAPI } from "@extendify/shared/types/spotify/playback";
import type { PlayerAPI, PlayerState, Song } from "@extendify/shared/types/spotify/player";
