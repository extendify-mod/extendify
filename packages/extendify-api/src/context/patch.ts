...
import { allPatches, patches } from "@extendify/api/registry";
import { PROPS_ARG_NAME } from "@extendify/shared/constants";
import { type AnyMatch, createExtendedRegExp } from "@extendify/shared/match";
import type { AnyFn, TargetPlatform } from "@extendify/shared/types";
